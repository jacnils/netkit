...
netkit::tcp::async_tcp_server::async_tcp_server(io::io_context& ctx, netkit::socket::addr addr)
	: addr_(std::move(addr)), listener_(std::make_unique<socket::native::native_async_listener>(ctx, addr_, socket::type::tcp)) {}
...
const netkit::socket::addr& netkit::tcp::async_tcp_server::get_local_endpoint() const noexcept {
